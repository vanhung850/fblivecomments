...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(162)(window);
	...
	window.shared.pubsub.on('configUpdate', function () {
	  document.querySelector('body').style['font-size'] = (window.shared.config.zoom || 1) + 'em';
	  document.querySelector('html').style.transform = 'scale(' + (window.shared.config.flipHorizontal ? -1 : 1) + ', ' + (window.shared.config.flipVertical ? -1 : 1) + ')';
	});
	
	// Show reactions in real-time (don't wait for "refresh")
	window.shared.pubsub.on('reactionsUpdate', function () {
	  document.querySelectorAll('.reactionGroup[data-reaction]').forEach(function (reactionGroup) {
	...
	window.shared.pubsub.on('teleprompterRefresh', function () {
	  // Countdown
	  ...
	  window.shared.comments({ deleted: false }).order('priority desc, created desc').each(function (comment) {
	    hadComments = true;
	    var commentFrag = document.querySelector('template#comment');
	    commentFrag.content.querySelector('[data-content="name"]').textContent = comment.name;
	    commentFrag.content.querySelector('[data-content="time"]').textContent = (0, _moment2.default)(Math.min(new Date(), comment.created)).fromNow();
	  ...
	  if (!hadComments) {
	    var noCommentsFrag = document.querySelector('template#noComments');
	...
	window.addEventListener('DOMContentLoaded', function () {
	  document.querySelector('.countdown').addEventListener('click', window.shared.pubsub.emit.bind(window.shared.pubsub, 'teleprompterRefresh'));
	  ...
	  if (window.location.hash !== '#slave') {
	    ...
	    document.querySelector('[data-action="moderate"]').addEventListener('click', function (e) {
	    ...
	    document.querySelector('[data-action="fullscreen"]').addEventListener('click', function (e) {
	      if (e.currentTarget.ownerDocument.webkitFullscreenElement || e.currentTarget.ownerDocument.mozFullScreenElement || e.currentTarget.ownerDocument.msFullscreenElement || e.currentTarget.ownerDocument.webkitFullscreenElement) {
	        (e.currentTarget.ownerDocument.webkitExitFullscreen || e.currentTarget.ownerDocument.mozCancelFullScreen || e.currentTarget.ownerDocument.msExitFullscreen || e.currentTarget.ownerDocument.webkitExitFullscreen).call(e.currentTarget.ownerDocument);
	        return;
	      }
	
	      (e.currentTarget.ownerDocument.documentElement.requestFullscreen || e.currentTarget.ownerDocument.documentElement.mozRequestFullScreen || e.currentTarget.ownerDocument.documentElement.webkitRequestFullScreen).call(e.currentTarget.ownerDocument.documentElement);
	    });
	  }
	  ...
	  function onFrame() {
	    ...
	    var timeLeft = window.shared.config.refreshInterval - (new Date() - window.shared.lastRefreshTime);
	    if (timeLeft <= 0) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=teleprompter-bundle.js.map